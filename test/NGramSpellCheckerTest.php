...
use olcaytaner\SpellChecker\NGramSpellChecker;
use PHPUnit\Framework\TestCase;

class NGramSpellCheckerTest extends TestCase
{
    ...
    public function setUp(): void{
        ...
        $this->nGram = new NGram(["../ngram.txt"]);
        $this->nGram->calculateNGramProbabilitiesSimple(new NoSmoothing());
        $this->nGramSpellChecker = new NGramSpellChecker($this->fsm, $this->nGram, null);
    }

    public function testNGramSpellChecker(){
        $original = [
        ...
        for ($i = 0; $i < count($modified); $i++) {
            $this->assertEquals($original[$i], $this->nGramSpellChecker->spellCheck($modified[$i]));
        }
    }

    public function testNGramSpellChecker2(){
        $original = [
    ...
    public function testNGramSpellChecker3(){
        $original = [
